#ifndef ZERO_NET_PACKETDISPATCHER_H_
#define ZERO_NET_PACKETDISPATCHER_H_

#include <zero/Types.h>
#include <zero/net/Protocol.h>
...
// TODO: This should probably just get rewritten as a general event dispatcher
// with ability to dispatch to class methods Currently can only dispatch to
// functions with a user pointer that allows for re-dispatching from that to a
// class method.
